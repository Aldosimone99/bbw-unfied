...
export async function getAuthorizationContext(
  ...
  const operationalPermissions = activeOperationalContext?.kind === 'organization'
    ...
    : activeProfessionalProfile && isOperationalProfessionalProfile(activeProfessionalProfile)
      ? ['professional_profile.read_own', 'professional_profile.update_own', 'patients.read', 'patients.link', 'patients.unlink', 'catalog.read', 'catalog.offering.read', 'catalog.offering.create', 'catalog.offering.update', 'catalog.offering.remove'] satisfies BackendPermissionCode[]
      : [];
