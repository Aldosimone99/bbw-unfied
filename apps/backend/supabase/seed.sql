...
values
  ...
  ('catalog.read', 'Read catalog', 'Read the BBW master catalog in the current context', false),
  ('catalog.offering.read', 'Read treatment offering', 'Read the current context treatment list', false),
  ('catalog.offering.create', 'Create treatment offering', 'Add a master treatment to the current context list', true),
  ('catalog.offering.update', 'Update treatment offering', 'Update price, duration, points or active state', true),
  ('catalog.offering.remove', 'Remove treatment offering', 'Deactivate a treatment in the current context list', true),
...
with role_permissions_seed (role_code, permission_code) as (
  values
    ...
    ('organization_owner', 'catalog.read'),
    ('organization_owner', 'catalog.offering.read'),
    ('organization_owner', 'catalog.offering.create'),
    ('organization_owner', 'catalog.offering.update'),
    ('organization_owner', 'catalog.offering.remove'),
    ...
    ('organization_admin', 'catalog.read'),
    ('organization_admin', 'catalog.offering.read'),
    ('organization_admin', 'catalog.offering.create'),
    ('organization_admin', 'catalog.offering.update'),
    ('organization_admin', 'catalog.offering.remove'),
    ...
    ('clinical_director', 'catalog.read'),
    ('clinical_director', 'catalog.offering.read'),
    ('clinical_director', 'catalog.offering.create'),
    ('clinical_director', 'catalog.offering.update'),
    ('clinical_director', 'catalog.offering.remove'),
    ('practitioner', 'dashboard.access'),
    ('practitioner', 'profile.read_own'),
    ('practitioner', 'profile.update_own'),
    ('practitioner', 'organization.read'),
    ('practitioner', 'catalog.read'),
    ('practitioner', 'catalog.offering.read'),
    ...
    ('office_manager', 'catalog.read'),
    ('office_manager', 'catalog.offering.read'),
    ('office_manager', 'catalog.offering.create'),
    ('office_manager', 'catalog.offering.update'),
    ('office_manager', 'catalog.offering.remove'),
